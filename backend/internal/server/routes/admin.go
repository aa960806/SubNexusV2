...
func RegisterAdminRoutes(
	...
	admin.Use(middleware.AdminComplianceGuard(settingService))
	{
		...
		registerSubNexusFeatureRoutes(admin, h)
	}
}
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/model-plaza", h.Admin.Setting.GetModelPlazaConfig)
		adminSettings.PUT("/model-plaza", h.Admin.Setting.UpdateModelPlazaConfig)
	}
}

func registerSubNexusFeatureRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	...
	broadcast := admin.Group("/broadcasts")
	{
		broadcast.GET("/config", h.Admin.Broadcast.GetConfig)
		broadcast.PUT("/config", h.Admin.Broadcast.UpdateConfig)
		broadcast.GET("", h.Admin.Broadcast.List)
		broadcast.POST("", h.Admin.Broadcast.Create)
		broadcast.PUT("/:id", h.Admin.Broadcast.Update)
		broadcast.DELETE("/:id", h.Admin.Broadcast.Delete)
		broadcast.POST("/cleanup", h.Admin.Broadcast.Cleanup)
	}
}
